...
### `picture`
This module is a ROM storing the image data and was generated with the Xilinx Memory Block IP. I first converted the logo image file into a COE file using a provided Matlab program, then used said COE file to generate the IP. 
